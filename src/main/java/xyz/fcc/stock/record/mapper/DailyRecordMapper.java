...
public interface DailyRecordMapper {
     ...
     */
    List<DailyRecord> selectDailyRecordByConditionWithPaging(@Param("startDate") LocalDate startDate,  @Param("endDate") LocalDate endDate,  @Param("content") String content,  @Param("offset") int offset,  @Param("limit") int limit);
}